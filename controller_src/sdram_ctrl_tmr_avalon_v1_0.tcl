...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "ACT_TO_RW_CYCLES" -parent ${Page_0}
  ipgui::add_param $IPINST -name "BANK_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "BURST_LENGTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "CAS_LAT_CYCLES" -parent ${Page_0}
  ipgui::add_param $IPINST -name "COLS_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "DATA_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "DQM_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "DRIVE_STRENGTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "EXT_MODE_REG_EN" -parent ${Page_0}
  ipgui::add_param $IPINST -name "GEN_ERR_INJ" -parent ${Page_0}
  ipgui::add_param $IPINST -name "IN_DATA_TO_PRE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "MODE_REG_CYCLES" -parent ${Page_0}
  ipgui::add_param $IPINST -name "NOP_BOOT_CYCLES" -parent ${Page_0}
  ipgui::add_param $IPINST -name "PRECH_COMMAND_PERIOD" -parent ${Page_0}
  ipgui::add_param $IPINST -name "RAM_BANKS" -parent ${Page_0}
  ipgui::add_param $IPINST -name "RAM_COLS" -parent ${Page_0}
  ipgui::add_param $IPINST -name "RAM_ROWS" -parent ${Page_0}
  ipgui::add_param $IPINST -name "REF_COMMAND_COUNT" -parent ${Page_0}
  ipgui::add_param $IPINST -name "REF_COMMAND_PERIOD" -parent ${Page_0}
  ipgui::add_param $IPINST -name "REF_PERIOD" -parent ${Page_0}
  ipgui::add_param $IPINST -name "ROW_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "SCRUBBER_WAIT_CYCLES" -parent ${Page_0}
  ipgui::add_param $IPINST -name "TMR_COLS" -parent ${Page_0}
