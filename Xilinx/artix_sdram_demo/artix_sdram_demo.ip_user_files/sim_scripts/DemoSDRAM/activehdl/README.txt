...
#
# Generated by export_simulation on Fri Oct 20 01:59:32 +0200 2017
#
################################################################################
...
switch to the './DemoSDRAM.sh' script.

./DemoSDRAM.sh -reset_run
...
./DemoSDRAM.sh -noclean_files

For more information on the script, please type './DemoSDRAM.sh -help'.
