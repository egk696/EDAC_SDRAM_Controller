...
# File: EDAC_SDRAM_Controller_Demo.tcl
# Generated on: Sun Jul 23 00:16:28 2017
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "EDAC_SDRAM_Controller"]} {
		puts "Project EDAC_SDRAM_Controller is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists EDAC_SDRAM_Controller]} {
		project_open -revision EDAC_SDRAM_Controller_Demo EDAC_SDRAM_Controller
	} else {
		project_new -revision EDAC_SDRAM_Controller_Demo EDAC_SDRAM_Controller
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "17:14:17  JULY 19, 2017"
	...
	set_global_assignment -name VHDL_FILE EDAC_SDRAM_Controller_Demo_Top.vhd
	set_global_assignment -name QIP_FILE EDAC_SDRAM_Controller_Demo/synthesis/EDAC_SDRAM_Controller_Demo.qip
	set_global_assignment -name VHDL_FILE ../other_src/sevensegmentdecoder.vhd
	set_global_assignment -name VHDL_FILE ../other_src/sevensegment_avalon_master_interface.vhd
	set_global_assignment -name VHDL_FILE ../controller_src/altera/sdram_ctrl_tmr_avs_multiport_interface.vhd
	set_global_assignment -name VHDL_FILE ../controller_src/altera/sdram_ctrl_tmr_avs_interface.vhd
	set_global_assignment -name VHDL_FILE ../controller_src/altera/sdram_ctrl_tmr.vhd
	set_global_assignment -name VHDL_FILE ../controller_src/tmr_voter.vhd
	set_global_assignment -name VHDL_FILE ../controller_src/tmr_fsm_watchdog.vhd
	set_global_assignment -name VHDL_FILE ../controller_src/tmr_error_generator.vhd
	set_global_assignment -name VHDL_FILE ../controller_src/tmr_address_mask.vhd
	set_global_assignment -name VHDL_FILE ../controller_src/sdram_ctrl_tmr_top.vhd
	set_global_assignment -name VHDL_FILE ../controller_src/sdram_ctrl_tmr_scrubber.vhd
	set_global_assignment -name VHDL_FILE ../controller_src/sdram_ctrl_tmr_healer.vhd
	set_global_assignment -name VHDL_FILE ../controller_src/sdram_ctrl_port_fixed_arbiter.vhd
	set_global_assignment -name VHDL_FILE ../controller_src/utils_pack.vhd
	set_global_assignment -name QIP_FILE ../controller_src/altera/IOBUF.qip
	set_global_assignment -name QIP_FILE ../controller_src/altera/OBUF.qip
	set_global_assignment -name CDF_FILE output_files/mychain_demo.cdf
	set_global_assignment -name SDC_FILE edac_sdram_controller_timing.sdc
	set_global_assignment -name QIP_FILE ../controller_src/altera/PLL_2OUT.qip
